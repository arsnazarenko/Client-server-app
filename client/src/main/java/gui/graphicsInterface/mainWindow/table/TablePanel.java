        ...
        private void filter() {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,
                        bundle.getString("error_3"), bundle.getString("error_title"),JOptionPane.ERROR_MESSAGE);
            } catch (IllegalArgumentException e) {
                JOptionPane.showMessageDialog(null,
                        bundle.getString("error_4"), bundle.getString("error_title"),JOptionPane.ERROR_MESSAGE);
            }
        }
