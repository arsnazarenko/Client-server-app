...
public class OrganizationView implements LocaleActionListener {
    ...
    public OrganizationView() {
        ...
        address = new JLabel();
        addressStreet = new JLabel();
        addressZipCode = new JLabel();
        town = new JLabel();
        townX = new JLabel();
        townY = new JLabel();
        townZ = new JLabel();
    ...
    public void localeChange(Locale locale) {
        ...
        saveObjectButton.setText(bundle.getString("save"));
        clearButton.setText(bundle.getString("clear"));
        name.setText(bundle.getString("name")+" ");
        coordsX.setText("x ");
        coordsY.setText("y ");
        employeesCount.setText(bundle.getString("employees")+" ");
        type.setText(bundle.getString("type")+" ");
        annualTurnover.setText(bundle.getString("annual_turnover")+" ");
        address.setText(bundle.getString("address")+" ");
        addressStreet.setText(bundle.getString("street")+" ");
        addressZipCode.setText(bundle.getString("zipcode")+" ");
        town.setText(bundle.getString("loc")+" ");
        townX.setText("x ");
        townY.setText("y ");
        townZ.setText("z ");
        townName.setText(bundle.getString("Lname")+ " ");
    }
}
